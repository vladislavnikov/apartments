  ...
  return (
    <footer>
      <div className="pt-6 sm:pt-8 md:pt-10 bg-no-repeat bg-cover bg-center bg-[url('/footer.jpg')]">
        <div className="mx-auto w-[92%] max-w-2xl sm:max-w-3xl md:max-w-4xl px-4 sm:px-8 md:px-12 bg-black/60 pt-6 pb-2 rounded-t-lg">
          <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-12 md:gap-20 text-base sm:text-base text-white">
            <div className="text-center">
              <h3 className="font-semibold text-base sm:text-base mb-1 italic">
                {locale === 'en' ? 'Contact Us' : 'Свържете се с нас'}
              </h3>
              <p className="text-base sm:text-base break-all sm:break-normal">
                office@todorov-co.com
              </p>
              <p className="text-base sm:text-base">+359 89 910 0537</p>
            ...
            <div className="text-center">
              ...
              <p className="text-base sm:text-base">
                {locale === Locale.EN ? 'Bulgaria' : 'България'}
              </p>
            </div>
          </div>

          <div className="mt-8 sm:mt-8 text-center text-base text-gray-200 px-2">
