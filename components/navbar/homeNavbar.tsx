      ...
      <nav className="w-full z-20 backdrop-blur-xs bg-white/30 ">
        <div className="max-w-screen-xl flex items-center justify-between mx-auto py-4 px-4 sm:px-6">
          ...
          <Link
            ...
            className="bg-white text-[#15385f] text-sm sm:text-base font-bold px-2 py-1 sm:px-4 sm:py-2 rounded border border-white/30 hover:bg-white/30 transition-all duration-200"
          >
            {locale === Locale.EN ? 'Book now' : 'Резервирай'}
          </Link>
        </div>
