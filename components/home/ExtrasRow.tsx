...
export default function ExtrasRow({ locale }: { locale: Locale }) {
  const extras: Extra[] =
    locale === Locale.EN
      ? [
          { label: 'Free Wi-Fi', imgSrc: '/home/icons/wifi.png' },
          { label: 'Fully Equipped Kitchen', imgSrc: '/home/icons/kitchen.png' },
          { label: 'Private Parking Space', imgSrc: '/home/icons/parking.png' },
