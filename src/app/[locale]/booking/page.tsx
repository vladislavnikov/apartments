  ...
  return (
    <section className="w-full h-auto flex flex-col">
      <div className="w-full bg-gray-100">
        <div className="max-w-3xl mx-auto px-4 md:px-6 text-center py-5">
          <p className="mx-auto max-w-3xl text-2xl md:text-3xl text-gray-900">{content.text}</p>
        </div>
      </div>
      <div className="max-w-3xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-4 mt-3 md:mt-0">
        <div className="flex flex-col gap-4 justify-center">
          <div className="grid grid-cols-[30px_1fr] gap-4 items-center mx-auto">
            ...
            <p className="text-black text-xl">Apartments by the river</p>
        ...
        <div className="w-full h-[300px] overflow-hidden border ">
          <iframe
